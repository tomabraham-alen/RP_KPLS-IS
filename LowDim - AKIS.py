...
# Loading the cantilever model from OpenTurns
...
fct_test = cbeam  # limit state function
...
PF, DoE, n_iter, gp_g, Y, IS_sample_size, cov_tot = Vb_AGP(mu, physicalSpaceDesignPoint, cov, fct_test, distribution,
